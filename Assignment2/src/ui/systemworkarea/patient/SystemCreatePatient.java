...
public class SystemCreatePatient extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblHeight.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        try{
            if(EmpytyFieldValidation()){
                ...
                if(RegexValidation()){
                    ...
                    JOptionPane.showMessageDialog(this,"Patient Registered Successfully. Patient Id : "+patientID+" and password: "+password);
